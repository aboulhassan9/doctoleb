  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <p className="font-mono text-[10px] font-black uppercase tracking-[0.2em] text-primary">Patient</p>
          <h2 className="mt-1 text-lg font-black text-slate-950">Search and confirm</h2>
        </div>
        {selectedIdentity ? (
      ...
      <div className="mt-3">
        ...
        <div className="relative">
          ...
          <input
            ...
            type="search"
            className="w-full rounded-xl border border-slate-200 bg-slate-50 py-2.5 pl-10 pr-4 text-sm font-semibold text-slate-900 outline-none transition focus:border-primary focus:bg-white focus:ring-4 focus:ring-primary/10"
