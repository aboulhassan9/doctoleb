...
export const PATIENT_FORM_FIELD_CONFIG_SELECT_FIELDS = [
  'id',
  'form_context',
  'scope',
  'doctor_id',
...
export const DOCUMENT_TEMPLATE_VERSION_SELECT_FIELDS = [
  'id',
  'template_id',
  'version_number',
  'status',
...
export const DOCUMENT_TEMPLATE_ASSET_SELECT_FIELDS = [
  'id',
  'template_id',
  'template_version_id',
  'asset_type',
...
export const DOCUMENT_RENDER_JOB_SELECT_FIELDS = [
  'id',
...
export const ANALYTICAL_REPORT_SELECT_FIELDS = [
  'id',
  'name',
  'description',
  'category',
...
export const ANALYTICAL_REPORT_VERSION_SELECT_FIELDS = [
  'id',
  'report_id',
  'version_number',
  'status',
...
export const ANALYTICAL_REPORT_RUN_SELECT_FIELDS = [
  'id',
  'report_id',
  'version_id',
  'filter_args',
  'result_summary',
  'scanned_row_estimate',
  'status',
  'error_code',
  'safe_error_summary',
  'requested_by',
